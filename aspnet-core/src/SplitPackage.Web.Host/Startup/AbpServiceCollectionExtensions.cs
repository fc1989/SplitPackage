...
namespace SplitPackage.Web.Host.Startup
{
    public static class AbpServiceCollectionExtensions
    {
        ...
        private static void ConfigureAspNetCore(IServiceCollection services, IIocResolver iocResolver)
        {
            ...
            {
                mvcOptions.Conventions.Add(new AbpAppServiceConvention(services));
                mvcOptions.Filters.AddService(typeof(AuthorizationFilter));
                ...
                mvcOptions.Filters.AddService(typeof(AbpResultFilter));
                mvcOptions.ModelBinderProviders.Insert(0, new AbpDateTimeModelBinderProvider());
            });
