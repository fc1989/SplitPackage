...
namespace SplitPackage.Migrations
{
    ...
    [Migration("20180626063032_task2")]
    partial class task2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SplitPackage.Business.LogisticRelated", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SplitPackage.Business.LogisticRelatedItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<long>("LogisticRelatedId");

                    b.HasKey("Id");

                    b.HasIndex("LogisticId");

                    b.HasIndex("LogisticRelatedId");
            ...
            modelBuilder.Entity("SplitPackage.Business.Product", b =>
                {
                    ...
                    b.Property<double>("DeclareTaxrate");
            ...
            modelBuilder.Entity("SplitPackage.Business.ProductSort", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SplitPackage.Business.SplitRuleItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SplitPackage.Business.TenantLogisticChannel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("LogisticChannelChange");
            ...
            modelBuilder.Entity("SplitPackage.MultiTenancy.OtherSystem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("SplitPackage.Business.LogisticRelatedItem", b =>
                {
                    ...
                    b.HasOne("SplitPackage.Business.LogisticRelated", "LogisticRelatedBy")
                        .WithMany("Items")
                        .HasForeignKey("LogisticRelatedId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
            ...
            modelBuilder.Entity("SplitPackage.Business.ProductClass", b =>
                {
                    b.HasOne("SplitPackage.Business.ProductSort", "ProductSortBy")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("SplitPackage.Business.TenantLogisticChannel", b =>
                {
                    ...
                    b.HasOne("SplitPackage.MultiTenancy.Tenant", "TenantBy")
                        .WithMany()
            ...
            modelBuilder.Entity("SplitPackage.MultiTenancy.Tenant", b =>
                {
                    ...
                    b.HasOne("SplitPackage.MultiTenancy.OtherSystem", "OtherSystem")
                        .WithMany()
                        .HasForeignKey("OtherSystemId");
                });
